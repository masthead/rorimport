    ...
    $.fn.columnFilter = function (options) {
        ...
        function fnCreateCheckbox(oTable, aData) {
            ...
            for (j = 0; j < iLen; j++) {
                ...
                //check button
                r += '<input class="search_init checkbox_filter" type="checkbox" id= "' + uniq + '" name= "' + localLabel + '" value="' + aData[j].value + '" >';
                r += '<label for="'+uniq+'">'+ aData[j].label +'</label>'
