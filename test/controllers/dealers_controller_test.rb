...
class DealersControllerTest < ActionController::TestCase
  ...
  test "should create dealer" do
    assert_difference('Dealer.count') do
      post :create, dealer: { dealer_focus_id: @dealer.dealer_focus_id, dealer_name: @dealer.dealer_name, dealer_status: @dealer.dealer_status }
    end
  ...
  test "should update dealer" do
    patch :update, id: @dealer, dealer: { dealer_focus_id: @dealer.dealer_focus_id, dealer_name: @dealer.dealer_name, dealer_status: @dealer.dealer_status }
    assert_redirected_to dealer_path(assigns(:dealer))
  end
